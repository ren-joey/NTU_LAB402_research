...
class InvertRes(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, stride=1, expand_ratio=4., act_layer=nn.GELU):
        ...
        Args:
            ...
            act_layer: the activation function. GELU
        """
        super().__init__()
