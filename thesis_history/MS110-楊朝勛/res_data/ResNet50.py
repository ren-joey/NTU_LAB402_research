...
class ResNet50(nn.Module):
    def __init__(self, in_chans=1, depths=[3, 4, 6, 3], num_classes=2, len_of_clinical_features=150):
        ...
        self.layer1 = ResNet_Block(first_channels=2, in_channels=2, out_channels=8, depths=depths[0])
        self.layer2 = ResNet_Block(first_channels=8, in_channels=4, out_channels=16, depths=depths[1])
        self.layer3 = ResNet_Block(first_channels=16, in_channels=8, out_channels=32, depths=depths[2])
        self.layer4 = ResNet_Block(first_channels=32, in_channels=16, out_channels=64, depths=depths[3])
